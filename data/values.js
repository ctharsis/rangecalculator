...
passiveStat["dreanbuster"] = {att:90, fDmg:0, pAtt:0, pDmg:35}; // ab was +80k, mutliplier?
passiveStat["aran"] = {att:80, fDmg:0, pAtt:0, pDmg:20};
passiveStat["bishopstaff"] = {att:40, fDmg:0, pAtt:0, pDmg:0};
passiveStat["bishopwand"] = {att:40, fDmg:0, pAtt:0, pDmg:0};
passiveStat["bowmaster"] = {att:80, fDmg:0, pAtt:25, pDmg:0};
passiveStat["darkknightpolearm"] = {att:30, fDmg:0, pAtt:0, pDmg:0};
passiveStat["darkknightspear"] = {att:30, fDmg:0, pAtt:0, pDmg:5};
passiveStat["demonslayer1ha"] = {att:100, fDmg:0, pAtt:0, pDmg:40};
passiveStat["demonslayer1hb"] = {att:100, fDmg:0, pAtt:0, pDmg:40};
passiveStat["evanstaff"] = {att:60, fDmg:0, pAtt:35, pDmg:0};
passiveStat["evanwand"] = {att:60, fDmg:0, pAtt:35, pDmg:0};
passiveStat["firepoisonstaff"] = {att:40, fDmg:0, pAtt:50, pDmg:0};
passiveStat["firepoisonwand"] = {att:40, fDmg:0, pAtt:50, pDmg:0};
passiveStat["hayato"] = {att:0, fDmg:0, pAtt:0, pDmg:30};
passiveStat["hero1ha"] = {att:30, fDmg:0, pAtt:0, pDmg:5};
passiveStat["hero2ha"] = {att:30, fDmg:0, pAtt:0, pDmg:5};
passiveStat["hero1hs"] = {att:30, fDmg:0, pAtt:0, pDmg:0};
passiveStat["hero2hs"] = {att:30, fDmg:0, pAtt:0, pDmg:0};
passiveStat["icelightningstaff"] = {att:40, fDmg:0, pAtt:50, pDmg:0};
passiveStat["icelightningwand"] = {att:40, fDmg:0, pAtt:50, pDmg:0};
passiveStat["kaiser"] = {att:50, fDmg:0, pAtt:30, pDmg:0};
passiveStat["kanna"] = {att:30, fDmg:0, pAtt:0, pDmg:60};
passiveStat["kinesis"] = {att:50, fDmg:20, pAtt:0, pDmg:0};
passiveStat["luminous"] = {att:40, fDmg:0, pAtt:0, pDmg:0};
passiveStat["mercedes"] = {att:50, fDmg:10, pAtt:0, pDmg:50}
